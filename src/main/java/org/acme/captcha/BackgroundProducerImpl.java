 ...
 */
@ApplicationScoped
public class BackgroundProducerImpl 
...
implements BackgroundProducer
{
	...
	public BufferedImage addBackground(BufferedImage baseImage)
	{
		...
		Color colorFrom = ClazzUtil.field(properties.background.from, Color.class);
		Color colorTo = ClazzUtil.field(properties.background.to, Color.class);
